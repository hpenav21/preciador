...
var LedcommandsComponent = (function () {
    ...
    LedcommandsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            if (params.id == "publicar") {
                console.log("calling publicar...");
                console.log(_this.http);
                _this.updatePrices_getPrices();
            }
        });
    ...
    LedcommandsComponent.prototype.publishPrices = function () {
        ...
        var dataValue = "";
        var thisRef = this;
        dataValue = this.getPriceHex(this.diesel) + "," + this.getPriceHex(this.magna) + "," + this.getPriceHex(this.premium) + ",";
        //**************************** */
        ...
        this.http.get('http://192.168.1.134:8000/serialport/' + cmd).subscribe(function (data) {
    ...
    LedcommandsComponent.prototype.getPricesFromFile = function () {
        ...
        var thisRef = this;
        this.http.get('http://192.168.1.134:8000/archivo/a').subscribe(function (data) {
            // Read the result field from the JSON response.
            var obj = data;
    ...
    LedcommandsComponent.prototype.updatePriceListFile = function () {
        ...
        var thisRef = this;
        this.http.get('http://192.168.1.134:8000/copyfile/a').subscribe(function (data) {
            // Read the result field from the JSON response.
            var obj = data;
...
var UpdatePricesComponent = (function () {
    ...
    UpdatePricesComponent.prototype.ngOnInit = function () {
        ...
        //ledComponent.getPricesFromFile();
    };
